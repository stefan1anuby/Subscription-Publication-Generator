...
public class Generator {
    ...
    public static Publication generatePublication() {
        ...
        pub.stationId = getRandom(stationIds);
        pub.city = getRandom(cities);
        pub.temp = rand.nextInt(41); // 0-40
        pub.rain = Math.round(rand.nextDouble() * 100) / 10.0; // 0.0 - 10.0
        pub.wind = rand.nextInt(31); // 0-30
        pub.direction = getRandom(directions);
        pub.date = LocalDate.now().minusDays(rand.nextInt(30));
        return pub;
    }
